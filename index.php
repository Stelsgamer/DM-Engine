                ...
                <div class="mt-2">
                  <div class="flex md:max-w-md relative">
                    <input type="text" name="domain" id="domain" autocomplete="none"
                      class="input order-last pl-14 border-text bg-input invalid:border-red" value="$echo"
                      placeholder="example.com" required>
                    <span class="absolute left-0 top-2 select-none pl-3 sm:text-sm">https://</span>
                  </div>
                </div>
              </div>
