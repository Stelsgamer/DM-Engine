          ...
          <div class="border-b border-desc pb-12">
            ...
            <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input type="text" name="first-name" id="first-name" autocomplete="given-name" placeholder="Даниил"
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input type="text" name="last-name" id="last-name" autocomplete="family-name" placeholder="Борисов"
                    class="input bg-input w-full border-text">
                </div>
              </div>
