              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input type="text" name="first-name" id="first-name" pattern="^[A-Za-zА-Яа-яЁё]+$"
                    autocomplete="given-firstname" placeholder="Даниил" class="input bg-input w-full border-text invalid:border-red">
                </div>
              </div>
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input type="text" name="last-name" id="last-name" pattern="^[A-Za-zА-Яа-яЁё]+$"
                    autocomplete="given-lastname" placeholder="Борисов" class="input bg-input w-full border-text invalid:border-red">
                </div>
              </div>
