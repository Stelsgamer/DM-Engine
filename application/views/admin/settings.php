      ...
      <div class="w-full lg:w-2/3 xl:w-1/2">
        <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
            ...
            <div class="mt-2">
              <div class="flex md:max-w-md">
                <input type="text" name="sitename" id="sitename" autocomplete="none"
                  class="input bg-input border-text invalid:border-red" value="$echo" placeholder="Your greate site name here" required>
              </div>
            </div>
          </div>
          ...
          <div class="col-span-6">
            ...
            <div class="mt-2">
              <textarea id="about" name="about" rows="1" class="input w-full border-text bg-input overflow-hidden" oninput="auto_grow(this)">$echo</textarea>
            </div>
          ...
          <div class="col-span-6">
            ...
            <div class="mt-2">
              <textarea id="keywords" name="keywords" rows="1" class="input w-full border-text bg-input overflow-hidden" oninput="auto_grow(this)">$echo</textarea>
            </div>
